...
router.post("/signin", async (req, res, next) => {
  ...
  try {
    ...
    /* Attention to syntax! toObject, not toOject */
    const objectUser = findUser.toObject();
    delete objectUser.password;
...
router.get("/logout", (req, res, next) => {
  req.session.destroy();
  /* You do not have a prefix declared, so your route is not /auth/signin, but /signin */
  res.redirect("/auth/signin");
});
